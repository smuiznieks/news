        ...
        $.ajax({
            ...
            if (data.note) {
                for (var i = 0; i < data.note.length; i++) {
                    var noteDiv = $('<div class="card"><div class="card-body"><p>' + data.note[i].body + '</p><button id="' + data.note[i]._id +'" class="btn btn-outline-danger btn-sm deleteButton" type="submit">Delete Note</button></div></div><br />');
